...
class VeterinariaController extends Controller
{
    ...
    {
        $filters = $request->only(['urgencias', 'ubicacion', 'verificado', 'servicio', 'buscar', 'reiniciar_filtros']);
    ...
    public function sugerencias(Request $request)
    {
        ...
        $sugerencias = $this->veterinariaService->getSugerencias($query, $limit);

        return $this->successResponse($sugerencias, 'Sugerencias de veterinarias obtenidas exitosamente');
    }
